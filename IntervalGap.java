...
public class IntervalGap {
    ...
    public static List<Interval> findEmployeeFreeTime(List<List<Interval>> schedule) {
        ...
        while (!minHeap.isEmpty()) {
            ...
            // interval
            System.out.println(previousInterval.start+":"+previousInterval.end+","+queueTop.interval.start+":"+queueTop.interval.end);
            ...
            if (employeeSchedule.size() > queueTop.intervalIndex + 1) {
                System.out.println("more employees: "+queueTop.employeeIndex+"-"+employeeSchedule.size()+":"+queueTop.intervalIndex + 1);
    ...
    public static void main(String[] args) {
        ...
        input.add(new ArrayList<Interval>(Arrays.asList(new Interval(2, 3),
                new Interval(6, 8))));
        List<Interval> result = IntervalGap.findEmployeeFreeTime(input);
        ...
        result = IntervalGap.findEmployeeFreeTime(input);
        System.out.print("Free intervals: ");
        for (Interval interval : result)
            System.out.print("[" + interval.start + ", " + interval.end + "] ");
        System.out.println();
